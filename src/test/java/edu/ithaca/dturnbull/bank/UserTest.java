...
public class UserTest {
        ...
        public void setGoalTest(){
               ...
               user1.createGoal("New York City", 100);
               assertTrue("Goal Name: New York City - $100 \n Amount Left: 100", user1.getGoals());

               user1.createGoal("Dyson Hairdryer", 500);
               assertTrue("Goal Name: New York City - $100 \n Amount Left: 100 \n Goal Name: Dyson Hairdryer - $500 \n Amount Left: 500",user1.getGoals());
        ...
        public void seeHistoryTest(){
                ...
                assertTrue("Last 5 Transactions: \n Shopping $10 \n Food $50");
