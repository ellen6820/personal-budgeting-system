...
public class UserTest {
    ...
    public void createLimitTest() throws InvalidInputException {
        ...
        assertThrows(InvalidInputException.class, () -> user.createLimit(-300.0));// throws exception when in
                                                                                  // negative
    }
    ...
    public void setGoalTest() {
        ...
        assertEquals(user1.seeGoals(),
                "Goal Name: New York City - $100 \n Amount Left: 100 \n Goal Name: Dyson Hairdryer - $500 \n Amount Left: 500");
    ...
    public void seeHistoryTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> user1.createTransaction("Savings", -90)); // negative
                                                                                                     // amount
        assertThrows(IllegalArgumentException.class, () -> user1.createTransaction("Savings", 1000000000)); // more
                                                                                                            // than
                                                                                                            // balance
    }
}
